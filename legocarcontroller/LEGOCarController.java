...
/*
 * This file is also derived from : NXT Remote Control by Jacek Fedorynski
 * 
...
package org.yejinjo.legocarcontroller;
...
import org.yejinjo.legocarcontroller.R;
...
public class LEGOCarController extends Activity implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWakeLock = mPowerManager.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "LEGO Car Controller");
    ...
    private void setupUI() {
        if (mControlsMode == MODE_BUTTONS) {
            ...
            buttonLeft.setOnTouchListener(new DirectionButtonOnTouchListener(1, -1));
            ...
            buttonRight.setOnTouchListener(new DirectionButtonOnTouchListener(-1, 1));
